{
  ...
  openscadEnabled = threedEnabled && config.features.gui.threed.openscad.enable;
  cfg = config.features.gui.threed.openscad.libraries;
in {
  options.features.gui.threed.openscad.libraries = lib.mkOption {
    type = lib.types.bool;
    default =
      if openscadEnabled
      then true
