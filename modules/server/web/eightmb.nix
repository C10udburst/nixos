    ...
    lib.mkMerge [
      ...
      })
      {
        ...
        systemd.tmpfiles.rules = [
          "d ${storage}/eightmb 0750 eightmb web - -"
          "z ${storage}/eightmb 0750 eightmb web - -"
          "d ${storage}/eightmb/outputs 0750 eightmb web - -"
          "d ${storage}/eightmb/uploads 0750 eightmb web - -"
        ];
